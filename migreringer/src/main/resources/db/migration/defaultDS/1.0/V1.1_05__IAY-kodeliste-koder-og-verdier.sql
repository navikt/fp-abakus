...
VALUES (nextval('seq_kodeliste'), 'ORGANISASJONSTYPE', 'JURIDISK_ENHET', 'NB', 'Juridisk enhet');

INSERT INTO KODELISTE (id, kode, beskrivelse, kodeverk, gyldig_fom)
VALUES (nextval('seq_kodeliste'), 'VIRKSOMHET', 'Virksomhet', 'ORGANISASJONSTYPE', to_date('2000-01-01', 'YYYY-MM-DD'));
INSERT INTO KODELISTE_NAVN_I18N (id, kl_kodeverk, kl_kode, sprak, navn)
VALUES (nextval('seq_kodeliste'), 'ORGANISASJONSTYPE', 'VIRKSOMHET', 'NB', 'Virksomhet');

INSERT INTO KODELISTE (id, kode, beskrivelse, kodeverk, gyldig_fom)
VALUES (nextval('seq_kodeliste'), '-', 'Udefinert', 'ORGANISASJONSTYPE', to_date('2000-01-01', 'YYYY-MM-DD'));
INSERT INTO KODELISTE_NAVN_I18N (id, kl_kodeverk, kl_kode, sprak, navn)
VALUES (nextval('seq_kodeliste'), 'ORGANISASJONSTYPE', '-', 'NB', 'Udefinert');
...
VALUES (nextval('seq_kodeliste'), 'ANNET', 'annet', 'Annet', 'NÆRINGSINNTEKT_TYPE',
        to_date('2000-01-01', 'YYYY-MM-DD'));
INSERT INTO KODELISTE_NAVN_I18N (id, kl_kodeverk, kl_kode, sprak, navn)
VALUES (nextval('seq_kodeliste'), 'NÆRINGSINNTEKT_TYPE', 'ANNET', 'NB', 'Annet');
...
INSERT INTO KODELISTE_NAVN_I18N (id, kl_kodeverk, kl_kode, sprak, navn)
VALUES (nextval('seq_kodeliste'), 'NÆRINGSINNTEKT_TYPE', 'DAGPENGER_TIL_FISKER', 'NB', 'Dagpenger til fisker');
...
INSERT INTO KODELISTE_NAVN_I18N (id, kl_kodeverk, kl_kode, sprak, navn)
VALUES (nextval('seq_kodeliste'), 'NÆRINGSINNTEKT_TYPE', 'DAGPENGER_VED_ARBEIDSLØSHET', 'NB',
...
VALUES (nextval('seq_kodeliste'), 'LOTT_KUN_TRYGDEAVGIFT', 'lottKunTrygdeavgift', 'Lott kun trygdeavgift',
        'NÆRINGSINNTEKT_TYPE', to_date('2000-01-01', 'YYYY-MM-DD'));
INSERT INTO KODELISTE_NAVN_I18N (id, kl_kodeverk, kl_kode, sprak, navn)
VALUES (nextval('seq_kodeliste'), 'NÆRINGSINNTEKT_TYPE', 'LOTT_KUN_TRYGDEAVGIFT', 'NB', 'Lott kun trygdeavgift');

INSERT INTO KODELISTE (id, kode, OFFISIELL_KODE, beskrivelse, kodeverk, gyldig_fom)
VALUES (nextval('seq_kodeliste'), 'SYKEPENGER', 'sykepenger', 'Sykepenger', 'NÆRINGSINNTEKT_TYPE',
        to_date('2000-01-01', 'YYYY-MM-DD'));
INSERT INTO KODELISTE_NAVN_I18N (id, kl_kodeverk, kl_kode, sprak, navn)
VALUES (nextval('seq_kodeliste'), 'NÆRINGSINNTEKT_TYPE', 'SYKEPENGER', 'NB', 'Sykepenger (næringsinntekt)');

INSERT INTO KODELISTE (id, kode, OFFISIELL_KODE, beskrivelse, kodeverk, gyldig_fom)
VALUES (nextval('seq_kodeliste'), 'SYKEPENGER_TIL_DAGMAMMA', 'sykepengerTilDagmamma', 'Sykepenger til dagmamma',
        'NÆRINGSINNTEKT_TYPE', to_date('2000-01-01', 'YYYY-MM-DD'));
INSERT INTO KODELISTE_NAVN_I18N (id, kl_kodeverk, kl_kode, sprak, navn)
VALUES (nextval('seq_kodeliste'), 'NÆRINGSINNTEKT_TYPE', 'SYKEPENGER_TIL_DAGMAMMA', 'NB', 'Sykepenger til dagmamma');

INSERT INTO KODELISTE (id, kode, OFFISIELL_KODE, beskrivelse, kodeverk, gyldig_fom)
VALUES (nextval('seq_kodeliste'), 'SYKEPENGER_TIL_FISKER', 'sykepengerTilFisker', 'Sykepenger til fisker',
        'NÆRINGSINNTEKT_TYPE', to_date('2000-01-01', 'YYYY-MM-DD'));
INSERT INTO KODELISTE_NAVN_I18N (id, kl_kodeverk, kl_kode, sprak, navn)
VALUES (nextval('seq_kodeliste'), 'NÆRINGSINNTEKT_TYPE', 'SYKEPENGER_TIL_FISKER', 'NB', 'Sykepenger til fisker');
...
INSERT INTO KODELISTE_NAVN_I18N (id, kl_kodeverk, kl_kode, sprak, navn)
VALUES (nextval('seq_kodeliste'), 'NÆRINGSINNTEKT_TYPE', 'SYKEPENGER_TIL_JORD_OG_SKOGBRUKERE', 'NB',
...
VALUES (nextval('seq_kodeliste'), 'VEDERLAG', 'vederlag', 'Vederlag', 'NÆRINGSINNTEKT_TYPE',
        to_date('2000-01-01', 'YYYY-MM-DD'));
INSERT INTO KODELISTE_NAVN_I18N (id, kl_kodeverk, kl_kode, sprak, navn)
VALUES (nextval('seq_kodeliste'), 'NÆRINGSINNTEKT_TYPE', 'VEDERLAG', 'NB', 'Vederlag');
...
INSERT INTO KODELISTE_NAVN_I18N (id, kl_kodeverk, kl_kode, sprak, navn)
VALUES (nextval('seq_kodeliste'), 'NÆRINGSINNTEKT_TYPE', 'VEDERLAG_DAGMAMMA_I_EGETHJEM', 'NB',
        'Vederlag dagmamma i egethjem');

INSERT INTO KODELISTE (id, kode, beskrivelse, kodeverk, gyldig_fom)
VALUES (nextval('seq_kodeliste'), '-', 'Udefinert', 'NÆRINGSINNTEKT_TYPE', to_date('2000-01-01', 'YYYY-MM-DD'));
INSERT INTO KODELISTE_NAVN_I18N (id, kl_kodeverk, kl_kode, sprak, navn)
VALUES (nextval('seq_kodeliste'), 'NÆRINGSINNTEKT_TYPE', '-', 'NB', 'Udefinert');
