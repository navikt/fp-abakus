...
class ArbeidsforholdDtoTjenesteTest {
    ...
    void mapArbeidsforholdMedPermisjoner() {
        ...
        when(arbeidsforholdTjeneste.finnArbeidsforholdForIdentIPerioden(personIdent, aktørId, intervall))
                .thenReturn(Map.of(arbeidsgiverIdentifikator, arbeidsforhold));
        ...
        assertThat(arbeidsforholdDto.getFirst().getArbeidsforholdId().getEksternReferanse())
                .isEqualTo(eksternRef.getReferanse());
        ...
        assertThat(arbeidsavtaler.getFirst().periode().getFom())
                .isEqualTo(arbeidsavtalerTilMap.getFirst().getArbeidsavtaleFom());
        assertThat(arbeidsavtaler.getFirst().periode().getTom())
                .isEqualTo(arbeidsavtalerTilMap.getFirst().getArbeidsavtaleTom());
        assertThat(arbeidsavtaler.getFirst().stillingsprosent())
                .isEqualByComparingTo(arbeidsavtalerTilMap.getFirst().getStillingsprosent());
        assertThat(arbeidsavtaler.get(1).periode().getFom())
                .isEqualTo(arbeidsavtalerTilMap.get(1).getArbeidsavtaleFom());
        assertThat(arbeidsavtaler.get(1).periode().getTom()).isEqualTo(TIL_DATO);
        assertThat(arbeidsavtaler.get(1).stillingsprosent())
                .isEqualByComparingTo(arbeidsavtalerTilMap.get(1).getStillingsprosent());

        var permisjoner = arbeidsforholdDto.getFirst().getPermisjoner();
        assertThat(permisjoner.getFirst().getPeriode().getFom())
                .isEqualTo(permisjonerTilMap.getFirst().getPermisjonFom());
        assertThat(permisjoner.getFirst().getPeriode().getTom())
                .isEqualTo(permisjonerTilMap.getFirst().getPermisjonTom());
        assertThat(permisjoner.getFirst().getProsentsats())
                .isEqualByComparingTo(permisjonerTilMap.getFirst().getPermisjonsprosent());
        assertThat(permisjoner.getFirst().getType()).isEqualTo(PermisjonsbeskrivelseType.PERMISJON_MED_FORELDREPENGER);
        assertThat(permisjoner.get(1).getPeriode().getFom())
                .isEqualTo(permisjonerTilMap.get(1).getPermisjonFom());
        assertThat(permisjoner.get(1).getPeriode().getTom()).isEqualTo(TIL_DATO);
        assertThat(permisjoner.get(1).getProsentsats())
                .isEqualByComparingTo(permisjonerTilMap.get(1).getPermisjonsprosent());
    ...
    private Arbeidsforhold lagArbeidsforhold(
            Arbeidsgiver arbeidsgiver, List<Arbeidsavtale> arbeidsavtaler, List<Permisjon> permisjoner) {
