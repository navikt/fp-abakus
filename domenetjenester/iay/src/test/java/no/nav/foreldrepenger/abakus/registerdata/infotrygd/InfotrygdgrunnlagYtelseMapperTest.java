...
class InfotrygdgrunnlagYtelseMapperTest {
    ...
    void skal_mappe_grunnlag_til_dagsats_for_kombinasjon_arbeid_og_dagpenger() {
        ...
        var orgnr = "973093681";
        builder.leggTilArbeidsforhold(
                new InfotrygdYtelseArbeid(orgnr, BigDecimal.valueOf(10000), InntektPeriodeType.MÅNEDLIG, false, null));
        var dagsatsArbeid = BigDecimal.valueOf(462);
        builder.leggTillAnvistPerioder(
                new InfotrygdYtelseAnvist(fom, tom, utbetalingsgrad, orgnr, false, dagsatsArbeid));

        builder.leggTilArbeidsforhold(
                new InfotrygdYtelseArbeid(null, BigDecimal.valueOf(1994), InntektPeriodeType.DAGLIG, false, null));
        var dagsatsDagpenger = BigDecimal.valueOf(1994);
        builder.leggTillAnvistPerioder(
                new InfotrygdYtelseAnvist(fom, tom, utbetalingsgrad, null, false, dagsatsDagpenger));
        ...
        var arbeidstakerAndel = ytelseAnvist.getYtelseAnvistAndeler().stream()
        ...
        var dagpengeAndel = ytelseAnvist.getYtelseAnvistAndeler().stream()
    ...
    void
        ...
        builder.leggTilArbeidsforhold(new InfotrygdYtelseArbeid(
                orgnr, BigDecimal.valueOf(15000.00), InntektPeriodeType.MÅNEDLIG, false, null));
        builder.leggTilArbeidsforhold(new InfotrygdYtelseArbeid(
                orgnr2, BigDecimal.valueOf(495.00), InntektPeriodeType.UKENTLIG, false, null));
        ...
        var arbeid1 = ytelseAnvist.getYtelseAnvistAndeler().stream()
                .filter(a -> a.getArbeidsgiver().isPresent()
