...
class InntektTjenesteImplTest {
    ...
    void skal_kalle_consumer_og_oversette_response() throws Exception {
        ...
        arbeidsInntektInformasjonMnd1.setInntektListe(Collections.singletonList(opprettInntekt(
                new BigDecimal(50),
                GJELDENDE_MÅNED.minusMonths(3),
                null,
                SYKEPENGER,
        ...
        arbeidsInntektInformasjonMnd2
                .getInntektListe()
                .add(opprettInntekt(
                        new BigDecimal(100),
                        GJELDENDE_MÅNED.minusMonths(2),
                        null,
                        SYKEPENGER,
                        InntektType.YTELSE_FRA_OFFENTLIGE));
        arbeidsInntektInformasjonMnd2
        ...
        arbeidsInntektInformasjonMnd3.setInntektListe(Collections.singletonList(opprettInntekt(
                new BigDecimal(400), GJELDENDE_MÅNED.minusMonths(1), arbeidsplassen, null, InntektType.LOENNSINNTEKT)));
        ...
        FinnInntektRequest finnInntektRequest = FinnInntektRequest.builder(
                        GJELDENDE_MÅNED.minusMonths(3), GJELDENDE_MÅNED)
                .medFnr(FNR)
                .build();
    ...
    void skal_avkorte_periode_gi_tom_response() throws Exception {
        ...
        FinnInntektRequest finnInntektRequest = FinnInntektRequest.builder(
                        tidligst.minusMonths(3), tidligst.plusMonths(3))
                .medFnr(FNR)
                .build();

        // Act
        final InntektsInformasjon inntektsInformasjon =
                inntektTjeneste.finnInntekt(finnInntektRequest, InntektskildeType.INNTEKT_OPPTJENING);
    ...
    private Inntekt opprettInntekt(
            BigDecimal beløp, YearMonth måned, Aktoer virksomhet, String beskrivelse, InntektType inntektType) {
