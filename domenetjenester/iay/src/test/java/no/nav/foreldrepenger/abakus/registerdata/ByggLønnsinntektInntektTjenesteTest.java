...
class ByggLønnsinntektInntektTjenesteTest {
    ...
    void skal_mappe_svalbarinntekt() {
        ...
        var svalbardinntekt = månedsinntektBuilder
        ...
        var inntektsInformasjon =
                new InntektsInformasjon(List.of(svalbardinntekt), InntektskildeType.INNTEKT_BEREGNING);
        ...
        ByggLønnsinntektInntektTjeneste.mapLønnsinntekter(
                inntektsInformasjon, aktørInntektBuilder, arbeidsgivereLookup);
    ...
    void skal_prioritere_NETTOLØNN_FOR_SJØFOLK() {
        ...
        var særskiltFradrag = månedsinntektBuilder
                .medBeløp(BigDecimal.TEN)
                .medMåned(YearMonth.now())
                .medArbeidsgiver(ORGNR)
                .medArbeidsforholdRef(null)
        ...
        var inntektsInformasjon =
                new InntektsInformasjon(List.of(svalbardinntekt, særskiltFradrag), InntektskildeType.INNTEKT_BEREGNING);
        var arbeidsgivereLookup = Map.of(ORGNR, Arbeidsgiver.virksomhet(new OrgNummer(ORGNR)));
        ...
        assertThat(inntektspost.getInntektspostType()).isEqualTo(InntektspostType.LØNN);
        assertThat(inntektspost.getLønnsinntektBeskrivelse()).isEqualTo(LønnsinntektBeskrivelse.UDEFINERT);
        assertThat(inntektspost.getSkatteOgAvgiftsregelType())
                .isEqualTo(SkatteOgAvgiftsregelType.NETTOLØNN_FOR_SJØFOLK);
        assertThat(inntektspost.getBeløp().getVerdi().compareTo(BigDecimal.valueOf(20)))
                .isEqualTo(0);
    }
    ...
    void skal_prioritere_SÆRSKILT_FRADRAG_FOR_SJØFOLK() {
        ...
        assertThat(inntektspost.getLønnsinntektBeskrivelse()).isEqualTo(LønnsinntektBeskrivelse.UDEFINERT);
        assertThat(inntektspost.getSkatteOgAvgiftsregelType())
                .isEqualTo(SkatteOgAvgiftsregelType.SÆRSKILT_FRADRAG_FOR_SJØFOLK);
        assertThat(inntektspost.getBeløp().getVerdi().compareTo(BigDecimal.valueOf(20)))
                .isEqualTo(0);
    }
    ...
    void skal_mappe_omsorgsstønad() {
        ...
        var omsorgsstønad = månedsinntektBuilder
                .medBeløp(BigDecimal.TEN)
                .medMåned(YearMonth.now())
                .medArbeidsgiver(ORGNR)
                .medArbeidsforholdRef(null)
                .medLønnsbeskrivelseKode(null)
                .medLønnsbeskrivelseKode(
        ...
        assertThat(inntektspost.getLønnsinntektBeskrivelse())
                .isEqualTo(LønnsinntektBeskrivelse.KOMMUNAL_OMSORGSLOENN_OG_FOSTERHJEMSGODTGJOERELSE);
        assertThat(inntektspost.getBeløp().getVerdi().compareTo(BigDecimal.valueOf(10)))
                .isEqualTo(0);
    }
    ...
    void skal_mappe_omsorgsstønad_ved_fleire_beskrivelser() {
        ...
        var ukjentLønn = månedsinntektBuilder
                .medBeløp(BigDecimal.TEN)
                .medMåned(YearMonth.now())
                .medArbeidsgiver(ORGNR)
                .medArbeidsforholdRef(null)
        ...
        var inntektsInformasjon =
                new InntektsInformasjon(List.of(omsorgsstønad, ukjentLønn), InntektskildeType.INNTEKT_BEREGNING);
        var arbeidsgivereLookup = Map.of(ORGNR, Arbeidsgiver.virksomhet(new OrgNummer(ORGNR)));
