...
class MedlemskortUtbetalingsgrunnlagSakMapperTest {
    ...
    void testMappingKonsistens() {
        ...
        assertThat(meldekortUtbetalingsgrunnlagSakDto.meldekortene())
                .hasSameSizeAs(domeneobjekt.getMeldekortene())
                .hasSize(1);
        var meldekortUtbetalingsgrunnlagMeldekortDto =
                meldekortUtbetalingsgrunnlagSakDto.meldekortene().get(0);
        var meldekortDomene = domeneobjekt.getMeldekortene().get(0);
        assertThat(meldekortUtbetalingsgrunnlagMeldekortDto.meldekortFom())
                .isEqualTo(meldekortDomene.getMeldekortFom());
        assertThat(meldekortUtbetalingsgrunnlagMeldekortDto.meldekortTom())
                .isEqualTo(meldekortDomene.getMeldekortTom());
        ...
        assertThat(meldekortUtbetalingsgrunnlagMeldekortDto.utbetalingsgrad())
                .isEqualTo(meldekortDomene.getUtbetalingsgrad());

        assertThat(tilType(meldekortUtbetalingsgrunnlagSakDto.type())).isEqualTo(domeneobjekt.getYtelseType());
        assertThat(tilTilstand(meldekortUtbetalingsgrunnlagSakDto.tilstand()))
                .isEqualTo(domeneobjekt.getYtelseTilstand());
        assertThat(tilKilde(meldekortUtbetalingsgrunnlagSakDto.kilde())).isEqualTo(domeneobjekt.getKilde());
        assertThat(meldekortUtbetalingsgrunnlagSakDto.saksnummer())
                .isEqualTo(domeneobjekt.getSaksnummer().getVerdi());
        ...
        assertThat(meldekortUtbetalingsgrunnlagSakDto.vedtaksPeriodeFom())
                .isEqualTo(domeneobjekt.getVedtaksPeriodeFom());
        assertThat(meldekortUtbetalingsgrunnlagSakDto.vedtaksPeriodeTom())
                .isEqualTo(domeneobjekt.getVedtaksPeriodeTom());
        assertThat(meldekortUtbetalingsgrunnlagSakDto.vedtaksDagsats().verdi())
                .isEqualTo(domeneobjekt.getVedtaksDagsats().getVerdi());
    }
}
