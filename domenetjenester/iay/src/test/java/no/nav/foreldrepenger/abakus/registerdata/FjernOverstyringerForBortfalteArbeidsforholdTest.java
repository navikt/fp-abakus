...
class FjernOverstyringerForBortfalteArbeidsforholdTest {
    ...
    void skal_fjerne_overstyringer_for_arbeidsforhold() {
        ...
        Set<ArbeidsforholdIdentifikator> innhentetArbeidsforhold = Set.of(new ArbeidsforholdIdentifikator(
                new Organisasjon(orgnr.getId()), eksternRef, ArbeidType.ORDINÆRT_ARBEIDSFORHOLD.getKode()));
        ...
        ArbeidsforholdOverstyringBuilder overstyringBuilder = ArbeidsforholdOverstyringBuilder.oppdatere(
                        Optional.empty())
                .medArbeidsgiver(virksomhet)
                .medArbeidsforholdRef(ref);
        InternArbeidsforholdRef ref2 = InternArbeidsforholdRef.nyRef();
        ArbeidsforholdOverstyringBuilder overstyringBuilder2 = ArbeidsforholdOverstyringBuilder.oppdatere(
                        Optional.empty())
                .medArbeidsgiver(virksomhet)
        ...
        ArbeidsforholdOverstyring gjenværendeOverstyring =
                nyInformasjon.getOverstyringer().iterator().next();
