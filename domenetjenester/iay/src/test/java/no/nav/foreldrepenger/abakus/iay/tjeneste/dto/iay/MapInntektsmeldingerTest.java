...
class MapInntektsmeldingerTest {
    ...
    private final KoblingTjeneste koblingTjeneste =
            new KoblingTjeneste(repository, new LåsRepository(jpaExtension.getEntityManager()));
    private final InntektArbeidYtelseRepository iayRepository =
            new InntektArbeidYtelseRepository(jpaExtension.getEntityManager());
    ...
    void skal_hente_alle_inntektsmeldinger_for_fagsak_uten_duplikater() {
        ...
        Inntektsmelding im = InntektsmeldingBuilder.builder()
                ...
                .build();
        ArbeidsforholdInformasjonBuilder arbeidsforholdInformasjon =
        ...
        // Act
        Map<Inntektsmelding, ArbeidsforholdInformasjon> alleIm =
                iayTjeneste.hentArbeidsforholdinfoInntektsmeldingerMapFor(aktørId, saksnummer, foreldrepenger);
    ...
    @Test
    void
            skal_hente_alle_inntektsmeldinger_for_fagsak_uten_duplikater_med_flere_versjoner_av_arbeidsforholdInformasjon() {
        // Arrange
        Saksnummer saksnummer = new Saksnummer(SAKSNUMMER);
        KoblingReferanse koblingReferanse = new KoblingReferanse(UUID.randomUUID());
        AktørId aktørId = new AktørId("1234123412341");
        ...
        ArbeidsforholdInformasjonBuilder arbeidsforholdInfo1 =
                ArbeidsforholdInformasjonBuilder.builder(Optional.empty());
        ...
        ArbeidsforholdInformasjonBuilder arbeidsforholdInfo2 = ArbeidsforholdInformasjonBuilder.builder(
                        Optional.of(arbeidsforholdInfo1.build()))
        ...
        InntektArbeidYtelseGrunnlagBuilder grBuilder = InntektArbeidYtelseGrunnlagBuilder.oppdatere(
                        iayRepository.hentInntektArbeidYtelseForBehandling(koblingReferanse))
    ...
    void skal_mappe_en_inntektsmelding_til_første_refusjonsdato_og_første_innsendelsesdato() {
        ...
        Kobling nyesteKobling = koblingTjeneste
                .hentSisteFor(aktørId, saksnummer, foreldrepenger)
                .orElseThrow();
        RefusjonskravDatoerDto refusjonskravDatoerDto = MapInntektsmeldinger.mapRefusjonskravdatoer(
                alleIm, iayTjeneste.hentAggregat(nyesteKobling.getKoblingReferanse()));

        // Assert
        assertThat(refusjonskravDatoerDto.getRefusjonskravDatoer().size()).isEqualTo(1);
        assertThat(refusjonskravDatoerDto
                        .getRefusjonskravDatoer()
                        .get(0)
                        .getArbeidsgiver()
                        .getIdent())
                .isEqualTo(virksomhet.getIdentifikator());
        assertThat(refusjonskravDatoerDto.getRefusjonskravDatoer().get(0).getFørsteDagMedRefusjonskrav())
                .isEqualTo(startPermisjon);
        assertThat(refusjonskravDatoerDto.getRefusjonskravDatoer().get(0).getFørsteInnsendingAvRefusjonskrav())
                .isEqualTo(innsendingstidspunkt.toLocalDate());
    }

    @Test
    void
            skal_mappe_en_inntektsmelding_til_første_refusjonsdato_og_første_innsendelsesdato_når_startdato_permisjon_er_null() {
        // Arrange
        Saksnummer saksnummer = new Saksnummer(SAKSNUMMER);
        KoblingReferanse koblingReferanse = new KoblingReferanse(UUID.randomUUID());
        AktørId aktørId = new AktørId("1234123412341");
        ...
        Kobling nyesteKobling =
                koblingTjeneste.hentSisteFor(aktørId, saksnummer, ytelseType).orElseThrow();
        RefusjonskravDatoerDto refusjonskravDatoerDto = MapInntektsmeldinger.mapRefusjonskravdatoer(
                alleIm, iayTjeneste.hentAggregat(nyesteKobling.getKoblingReferanse()));
    ...
    void skal_mappe_til_refusjonskravdatoer_for_flere_arbeidsgivere_med_refusjonskrav() {
        ...
        Inntektsmelding im2 = InntektsmeldingBuilder.builder()
                ...
                .build();
        iayRepository.lagre(
                koblingReferanse, ArbeidsforholdInformasjonBuilder.builder(Optional.empty()), List.of(im, im2));
        ...
        assertThat(refusjonskravDatoerDto
                        ...
                        .getArbeidsgiver()
                        .getIdent())
                .isEqualTo(virksomhet2.getIdentifikator());
        assertThat(refusjonskravDatoerDto.getRefusjonskravDatoer().get(0).getFørsteDagMedRefusjonskrav())
                .isEqualTo(startPermisjon);
        assertThat(refusjonskravDatoerDto.getRefusjonskravDatoer().get(0).getFørsteInnsendingAvRefusjonskrav())
                .isEqualTo(innsendingstidspunkt2.toLocalDate());
        ...
        assertThat(refusjonskravDatoerDto
                        ...
                        .getIdent())
                .isEqualTo(virksomhet.getIdentifikator());
        assertThat(refusjonskravDatoerDto.getRefusjonskravDatoer().get(1).getFørsteDagMedRefusjonskrav())
                .isEqualTo(startPermisjon);
        assertThat(refusjonskravDatoerDto.getRefusjonskravDatoer().get(1).getFørsteInnsendingAvRefusjonskrav())
                .isEqualTo(innsendingstidspunkt.toLocalDate());
    }
    ...
    void skal_mappe_til_refusjonskravdatoer_for_flere_arbeidsforhold_med_refusjonskrav() {
        ...
        InternArbeidsforholdRef ref1 =
                builder.finnEllerOpprett(virksomhet, EksternArbeidsforholdRef.ref("rgjg98jj3j43"));
        Inntektsmelding im = InntektsmeldingBuilder.builder()
                .medArbeidsgiver(virksomhet)
                ...
                .build();
        LocalDateTime innsendingstidspunkt2 = innsendingstidspunkt.plusDays(10);
        InternArbeidsforholdRef ref2 =
                builder.finnEllerOpprett(virksomhet, EksternArbeidsforholdRef.ref("28r9283yr92"));
        Inntektsmelding im2 = InntektsmeldingBuilder.builder()
                .medArbeidsgiver(virksomhet)
