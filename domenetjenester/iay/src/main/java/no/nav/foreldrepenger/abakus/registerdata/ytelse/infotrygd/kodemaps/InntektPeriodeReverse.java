...
public class InntektPeriodeReverse {
    ...
    private static final Map<String, InntektPeriodeType> INNTEKT_PERIODE_TYPE_MAP = Map.of(DAGLIG_KILDE, InntektPeriodeType.DAGLIG, UKENTLIG_KILDE,
        InntektPeriodeType.UKENTLIG, BIUKENTLIG_KILDE, InntektPeriodeType.BIUKENTLIG, MÅNEDLIG_KILDE, InntektPeriodeType.MÅNEDLIG, ÅRLIG_KILDE,
        InntektPeriodeType.ÅRLIG, FASTSATT25PAVVIK_KILDE, InntektPeriodeType.FASTSATT25PAVVIK, PREMIEGRUNNLAG_KILDE,
