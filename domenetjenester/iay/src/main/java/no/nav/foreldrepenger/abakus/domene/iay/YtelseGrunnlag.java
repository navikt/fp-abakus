...
import no.nav.foreldrepenger.abakus.domene.iay.kodeverk.ArbeidskategoriKodeverdiConverter;
...
public class YtelseGrunnlag extends BaseEntitet {
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof YtelseGrunnlag)) return false;
    ...
    public String toString() {
        return "YtelseGrunnlagEntitet{" +
            ...
            ", dekngradProsent=" + dekningsgradProsent +
