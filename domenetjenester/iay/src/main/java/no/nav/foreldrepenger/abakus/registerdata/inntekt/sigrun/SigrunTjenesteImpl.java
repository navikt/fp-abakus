...
public class SigrunTjenesteImpl implements SigrunTjeneste {
    ...
    @Override
    public void hentOgLagrePGI(Kobling behandling, AktørId aktørId) {
        ...
        InntektArbeidYtelseAggregatBuilder aggregatBuilder = inntektArbeidYtelseTjeneste.opprettBuilderForRegister(behandling.getId());
        ...
        inntektArbeidYtelseTjeneste.lagre(behandling.getId(), aggregatBuilder);
    }
