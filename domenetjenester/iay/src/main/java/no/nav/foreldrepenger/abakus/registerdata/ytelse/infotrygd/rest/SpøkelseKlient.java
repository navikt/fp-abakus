...
@RestClientConfig(
        ...
        endpointProperty = "spokelse.grunnlag.url",
        endpointDefault = "https://spokelse.intern.nav.no/grunnlag",
        scopesProperty = "spokelse.grunnlag.scopes",
        scopesDefault = "api://prod-gcp.tbd.spokelse/.default")
