...
public class InfotrygdYtelseGrunnlag {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(vedtattTidspunkt, that.vedtattTidspunkt) && Objects.equals(ytelseType, that.ytelseType) && Objects.equals(ytelseStatus,
            that.ytelseStatus) && Objects.equals(utbetaltePerioder, that.utbetaltePerioder) && Objects.equals(vedtaksPeriodeFom,
            that.vedtaksPeriodeFom) && Objects.equals(vedtaksPeriodeTom, that.vedtaksPeriodeTom) && Objects.equals(kategori, that.kategori)
            && Objects.equals(arbeidsforhold, that.arbeidsforhold) && Objects.equals(dekningsgrad, that.dekningsgrad) && Objects.equals(gradering,
            that.gradering) && Objects.equals(fødselsdatoBarn, that.fødselsdatoBarn) && Objects.equals(opprinneligIdentdato,
            that.opprinneligIdentdato);
    }

    @Override
    public int hashCode() {
        return Objects.hash(vedtattTidspunkt, ytelseType, ytelseStatus, utbetaltePerioder, vedtaksPeriodeFom, vedtaksPeriodeTom, kategori,
            arbeidsforhold, dekningsgrad, gradering, fødselsdatoBarn, opprinneligIdentdato);
    }

    @Override
    public String toString() {
        return "InfotrygdYtelseGrunnlag{" + "identdato=" + vedtattTidspunkt + ", ytelseType=" + ytelseType + ", ytelseStatus=" + ytelseStatus
            + ", utbetaltePerioder=" + utbetaltePerioder + ", vedtaksPeriodeFom=" + vedtaksPeriodeFom + ", vedtaksPeriodeTom=" + vedtaksPeriodeTom
            + ", kategori=" + kategori + ", arbeidsforhold=" + arbeidsforhold + ", dekningsgrad=" + dekningsgrad + ", gradering=" + gradering
            + ", fødselsdatoBarn=" + fødselsdatoBarn + ", opprinneligIdentdato=" + opprinneligIdentdato + '}';
    }
