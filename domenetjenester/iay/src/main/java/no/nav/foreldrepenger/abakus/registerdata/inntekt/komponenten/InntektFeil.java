...
public interface InntektFeil extends DeklarerteFeil {
    ...
    @IntegrasjonFeil(feilkode = "FP-824246", feilmelding = "Feil ved kall til inntektstjenesten. Meld til #di_team_registre og #produksjonshendelser hvis dette skjer over lengre tidsperiode.", logLevel = LogLevel.ERROR)
