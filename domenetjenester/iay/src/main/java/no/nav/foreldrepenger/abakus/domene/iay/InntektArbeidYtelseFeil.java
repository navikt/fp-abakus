...
interface InntektArbeidYtelseFeil extends DeklarerteFeil {
    ...
    @TekniskFeil(feilkode = "FP-731232", feilmelding = "Finner ikke InntektArbeidYtelse grunnlag for kobling %s", logLevel = LogLevel.WARN)
    Feil fantIkkeForventetGrunnlagPåBehandling(KoblingReferanse koblingReferanse);
