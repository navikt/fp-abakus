...
@RestClientConfig(
        ...
        endpointProperty = "fpabakus.it.ps.grunnlag.url",
        endpointDefault = "http://k9-infotrygd-grunnlag-paaroerende-sykdom.k9saksbehandling/paaroerendeSykdom/grunnlag",
        scopesProperty = "fpabakus.it.ps.scopes",
        scopesDefault = "api://prod-fss.k9saksbehandling.k9-infotrygd-grunnlag-paaroerende-sykdom/.default")
