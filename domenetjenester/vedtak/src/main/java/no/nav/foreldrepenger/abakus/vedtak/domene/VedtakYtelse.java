...
public class VedtakYtelse extends BaseEntitet implements IndexKey {
    ...
    public String toString() {
        return "VedtakYtelseEntitet{" + "aktørId=" + aktørId + ", ytelseType=" + ytelseType + ", vedtattTidspunkt="
                + vedtattTidspunkt + ", vedtakReferanse=" + vedtakReferanse + ", periode=" + periode + ", saksnummer="
                + saksnummer + ", kilde=" + kilde + '}';
    }
}
