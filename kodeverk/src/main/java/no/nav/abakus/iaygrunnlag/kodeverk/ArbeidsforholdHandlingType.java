...
public enum ArbeidsforholdHandlingType implements Kodeverdi {
    ...
    /**
     * @deprecated Tillater ikke nye sammenslåinger. Logikken var del av 5080 i FP, vil fases ut. Sist brukt 2019-11,
     *     støttes for legacy grunnlag inntil videre
     */
    ...
    BASERT_PÅ_INNTEKTSMELDING(
            "BASERT_PÅ_INNTEKTSMELDING",
            "Arbeidsforholdet som ikke ligger i AA-reg er basert på inntektsmelding",
            false),
    ...
    INNTEKT_IKKE_MED_I_BG(
            "INNTEKT_IKKE_MED_I_BG", "Inntekten til arbeidsforholdet skal ikke være med i beregningsgrunnlaget", false),
    ;
