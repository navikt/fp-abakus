...
public enum InntektYtelseType implements Kodeverdi {
    ...
    FERIEPENGER_FORELDREPENGER(
            "Feriepenger foreldrepenger", Kategori.YTELSE, YtelseType.FORELDREPENGER, "feriepengerForeldrepenger"),
    FERIEPENGER_SVANGERSKAPSPENGER(
            "Feriepenger svangerskapspenger",
            Kategori.YTELSE,
            YtelseType.SVANGERSKAPSPENGER,
            "feriepengerSvangerskapspenger"),
    FERIEPENGER_OMSORGSPENGER(
            "Feriepenger omsorgspenger", Kategori.YTELSE, YtelseType.OMSORGSPENGER, "feriepengerOmsorgspenger"),
    FERIEPENGER_OPPLÆRINGSPENGER(
            "Feriepenger opplæringspenger",
            Kategori.YTELSE,
            YtelseType.OPPLÆRINGSPENGER,
            "feriepengerOpplaeringspenger"),
    FERIEPENGER_PLEIEPENGER(
            "Feriepenger pleiepenger", Kategori.YTELSE, YtelseType.PLEIEPENGER_SYKT_BARN, "feriepengerPleiepenger"),
    ...
    FORELDREPENGER_NÆRING(
            "Foreldrepenger næring",
            Kategori.NÆRING,
            YtelseType.FORELDREPENGER,
            List.of(
                    "foreldrepenger",
                    "foreldrepengerTilDagmamma",
                    "foreldrepengerTilFisker",
                    "foreldrepengerTilJordOgSkogbrukere")),
    SVANGERSKAPSPENGER_NÆRING(
            "Svangerskapspenger næring",
            Kategori.NÆRING,
            YtelseType.SVANGERSKAPSPENGER,
            List.of(
                    "svangerskapspenger",
                    "svangerskapspengerTilDagmamma",
                    "svangerskapspengerTilFisker",
                    "svangerskapspengerTilJordOgSkogbrukere")),
    SYKEPENGER_NÆRING(
            "Sykepenger næring",
            Kategori.NÆRING,
            YtelseType.SYKEPENGER,
    ...
    OMSORGSPENGER_NÆRING(
            "Omsorgspenger næring",
            Kategori.NÆRING,
            YtelseType.OMSORGSPENGER,
            List.of(
                    "omsorgspenger",
                    "omsorgspengerTilDagmamma",
                    "omsorgspengerTilFisker",
                    "omsorgspengerTilJordOgSkogbrukere")),
    OPPLÆRINGSPENGER_NÆRING(
            "Opplæringspenger næring",
            Kategori.NÆRING,
            YtelseType.OPPLÆRINGSPENGER,
            List.of(
                    "opplaeringspenger",
                    "opplaeringspengerTilDagmamma",
                    "opplaeringspengerTilFisker",
                    "opplaeringspengerTilJordOgSkogbrukere")),
    PLEIEPENGER_NÆRING(
            "Pleiepenger næring",
            Kategori.NÆRING,
            ...
            List.of(
                    "pleiepenger",
                    "pleiepengerTilDagmamma",
                    "pleiepengerTilFisker",
                    "pleiepengerTilJordOgSkogbrukere")),
    DAGPENGER_NÆRING(
            "Dagpenger næring",
            Kategori.NÆRING,
            YtelseType.DAGPENGER,
    ...
    KOMPENSASJON_FOR_TAPT_PERSONINNTEKT(
            "Kompensasjon for tapt personinntekt",
            Kategori.NÆRING,
            YtelseType.FRISINN,
    ...
    public static InntektYtelseType finnForKodeverkEiersKode(Kategori kategori, String kode) {
        return Stream.of(values())
                ...
                .findFirst()
                .orElseThrow(() ->
                        new IllegalArgumentException("Ukjent YtelseInntektType: " + kode + " kategori " + kategori));
    }
