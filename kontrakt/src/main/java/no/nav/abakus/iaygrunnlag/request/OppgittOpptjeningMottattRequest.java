...
public class OppgittOpptjeningMottattRequest {
    ...
    @JsonCreator
    public OppgittOpptjeningMottattRequest(
            ...
            @JsonProperty(value = "oppgittOpptjening", required = true) @NotNull @Valid
    ...
    public String toString() {
        return getClass().getSimpleName() + "<saksnummer=" + saksnummer + ", koblingRef=" + koblingReferanse
