...
public class InntektArbeidYtelseGrunnlagRequest {
    ...
    /**
     * Forespørsel på kobling referanse gir kun siste grunnlag på koblingen (kobling er typisk eks. behandling).
     * Ignoreres dersom grunnlagReferanse er satt.
     */
    ...
    /**
     * Hvis satt til true hentes første opprettete versjon av grunnlaget, hvis false eller ikke satt hentes den siste
     * aktive grunnlaget.
     */
    ...
    public enum GrunnlagVersjon {
        ...
        /**
         * Default valg. Kun siste (dvs. aktiv) grunnlag per behandling. Typisk dersom man ønsker kun gjeldende
         * grunnlag.
         */
        SISTE,

        /**
         * første grunnlag per behandling (kan være aktivt hvis det også er eneste), ellers er det typisk starttilstand
         * for behandlingen. Normalt vil en konsument heller være interesset i {@link #SISTE} eller
         * {@link #FØRSTE_OG_SISTE}.
         */
        FØRSTE,

        /**
         * Både første og siste grunnlag per behandling (se #SISTE, #FØRSTE). Ignorerer mellomliggende versjoner på
         * samme behandling. Brukes typisk for å håndtere Revurdering (om det har vært endringer i behandlingen).
         */
        FØRSTE_OG_SISTE,
        ;
    }
