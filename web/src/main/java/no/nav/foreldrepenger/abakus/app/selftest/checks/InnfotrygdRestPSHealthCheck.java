...
@ApplicationScoped
public class InnfotrygdRestPSHealthCheck extends ExtHealthCheck {

    @Inject
    @KonfigVerdi(value = "fpabakus.it.ps.grunnlag.url")
    private String restUrl;  // NOSONAR

    InnfotrygdRestPSHealthCheck() {
        // for CDI proxy
    }

    @Override
    protected String getDescription() {
        return "Test av rs Infotrygd K9 ";
    }
    ...
    protected InternalResult performCheck() {
        ...
        // TODO: Finne måte å selfteste GET-endepunkt. Legg inn ping i fp-felles?
